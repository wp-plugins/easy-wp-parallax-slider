...
1.Upload:
Unzip easy_parallax_slider.zip file, and upload all files to your blog folder: <root>/wp-content/plugins/easy-parallax-slider
...
2. EPS new settings page (slide settings panel with each slide).
3. Open slide settings panel.
